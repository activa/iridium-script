...
internal static class ReflectionExtensions
{
    ...
    {
        return WalkType(type, t => t.GetProperties(BindingFlags.Instance).Where(pi => pi.Name == "Item" && SmartBinder.MatchParameters(types, pi.GetIndexParameters()))).FirstOrDefault();
    }
